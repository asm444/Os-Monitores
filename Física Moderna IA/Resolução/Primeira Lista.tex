...
\begin{equation*}
			\begin{split}
				(\Delta x')^2=\frac{1}{4}\left[\gamma^2((\Delta x- \Delta z)^2 +2(\Delta t)^2v^2)+2\gamma((\Delta x- \Delta z)(\Delta x+\Delta z\right.\\-\gamma \Delta tv\sqrt{2})-(\Delta x+\Delta z) (\Delta t)v\sqrt{2})
				\left.+(\Delta x+\Delta z)^2\right]
			\end{split}
\end{equation*}
...
\begin{equation*}
	\begin{split}
		(\Delta z')^2=\frac{1}{4}\left[\gamma^2(\Delta z- \Delta x)^2+2\gamma(\Delta z- \Delta x)(\Delta x+\Delta z+\gamma \Delta tv\sqrt{2})\right.\\
		\left.+(\Delta x+\Delta z)^2+2\gamma(\Delta x+\Delta z) (\Delta t)v\sqrt{2}+2\gamma^2 2(\Delta t)^2v^2\right]
	\end{split}
\end{equation*}

\begin{equation*}
	\begin{split}
		(\Delta z')^2=\frac{1}{4}\left[\gamma^2((\Delta z- \Delta x)^2 +2(\Delta t)^2v^2)+2\gamma((\Delta z- \Delta x)(\Delta x+\Delta z+\right.\\\gamma \Delta tv\sqrt{2})+(\Delta x+\Delta z) (\Delta t)v\sqrt{2})
		\left.+(\Delta x+\Delta z)^2\right]
	\end{split}
\end{equation*}
...
\begin{equation*}
	(\Delta t')^2 =(\frac{\gamma}{\sqrt{2}}\left[\frac{v}{c^2}(\Delta z-\Delta x)+\sqrt{2}\Delta t\right]  )^2
\end{equation*}

\begin{equation*}
	(\Delta t')^2 =\frac{\gamma^2}{2}\left[\frac{v}{c^2}(\Delta z-\Delta x)+\sqrt{2}\Delta t\right]^2
\end{equation*}

\begin{equation*}
	(\Delta t')^2 =\frac{\gamma^2}{2}\left[\frac{v^2}{c^4}(\Delta z-\Delta x)^2+2\frac{v}{c^2}(\Delta z-\Delta x)\sqrt{2}\Delta t+2(\Delta t)^2\right]
\end{equation*}
	%%%%%%%%%%%%%%%%%%%%%
	
substituindo $ (\Delta t')^2 $,$ (\Delta x')^2 $,$ (\Delta y')^2 $ e $ (\Delta z')^2 $ em 
...
\begin{equation*}
	\begin{split}
		\frac{1}{4}\left[\gamma^2((\Delta x- \Delta z)^2 +2(\Delta t)^2v^2)+2\gamma((\Delta x- \Delta z)(\Delta x+\Delta z\right.\\-\gamma \Delta tv\sqrt{2})+(\Delta x+\Delta z) (\Delta t)v\sqrt{2})
		\left.+(\Delta x+\Delta z)^2\right] \\
		+\frac{1}{4}\left[\gamma^2((\Delta z- \Delta x)^2 +2(\Delta t)^2v^2)+2\gamma((\Delta z- \Delta x)(\Delta x+\Delta z+\right.\\
		\gamma \Delta tv\sqrt{2})+(\Delta x+\Delta z) (\Delta t)v\sqrt{2}) \left.+(\Delta x+\Delta z)^2\right]\\
		+(\Delta y)^2\\
		-c^2\frac{\gamma^2}{2}\left[\frac{v^2}{c^4}(\Delta z-\Delta x)^2+2\frac{v}{c^2}(\Delta z-\Delta x)\sqrt{2}\Delta t+2(\Delta t)^2\right]\\
...
\begin{equation*}
	\begin{split}
		...
		\gamma \Delta tv\sqrt{2}+(\Delta x+\Delta z) (\Delta t)v\sqrt{2}) \left.+(\Delta x+\Delta z)^2\right]\\
		-c^2\frac{\gamma^2}{2}\left[\frac{v^2}{c^4}(\Delta z-\Delta x)^2+2\frac{v}{c^2}(\Delta z-\Delta x)\sqrt{2}\Delta t+2(\Delta t)^2\right]\\
		=(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}
...
\begin{equation*}
	\begin{split}
		\frac{1}{4}\left[\gamma^2((\Delta x- \Delta z)^2 +2(\Delta t)^2v^2)+2\gamma((\Delta x- \Delta z)(\Delta x+\Delta z\right.\\-\gamma \Delta tv\sqrt{2}-(\Delta x+\Delta z) (\Delta t)v\sqrt{2})
		\left.-(\Delta x+\Delta z)^2\right] \\
		+\gamma^2((\Delta z- \Delta x)^2 +2(\Delta t)^2v^2)+2\gamma((\Delta z- \Delta x)(\Delta x+\Delta z+\\
		\gamma \Delta tv\sqrt{2}+(\Delta x+\Delta z) (\Delta t)v\sqrt{2}) \left.+(\Delta x+\Delta z)^2\right]\\
		-\frac{\gamma^2}{2}\left[\frac{v^2}{c^2}(\Delta z-\Delta x)^2+2v(\Delta z-\Delta x)\sqrt{2}\Delta t+2c^2(\Delta t)^2\right]\\
		=(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}
...
\begin{equation*}
	\begin{split}
		\frac{1}{4}\left[\gamma^2((\Delta x- \Delta z)^2 +2(\Delta t)^2v^2)+2\gamma((\Delta x- \Delta z)(\Delta x+\Delta z\right.\\-\gamma \Delta tv\sqrt{2})-(\Delta x+\Delta z) (\Delta t)v\sqrt{2})
		\left.+(\Delta x+\Delta z)^2\right. \\
		+\gamma^2((\Delta x- \Delta z)^2 +2(\Delta t)^2v^2)+2\gamma(-(\Delta x- \Delta z)(\Delta x+\Delta z+\\
		\gamma \Delta tv\sqrt{2}+(\Delta x+\Delta z) (\Delta t)v\sqrt{2}) \left.+(\Delta x+\Delta z)^2\right]\\
		-\frac{\gamma^2}{2}\left[\frac{v^2}{c^2}(\Delta z-\Delta x)^2+2v(\Delta z-\Delta x)\sqrt{2}\Delta t+2c^2(\Delta t)^2\right]\\
		=(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
...
\begin{equation*}
	\begin{split}
	\frac{1}{4}\left[2\gamma^2((\Delta x- \Delta z)^2 +2(\Delta t)^2v^2)+\right.\\
	\left.2\gamma((\Delta x- \Delta z)(-2\gamma \Delta tv\sqrt{2})+2(\Delta x+\Delta z)^2\right]\\
	-\frac{\gamma^2}{2}\left[\frac{v^2}{c^2}(\Delta z-\Delta x)^2+2v(\Delta z-\Delta x)\sqrt{2}\Delta t+2c^2(\Delta t)^2\right]\\
	=(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}
...
\begin{equation*}
	\begin{split}
		\frac{1}{2}\left[\gamma^2((\Delta x- \Delta z)^2 +2(\Delta t)^2v^2)+\right.\\
		\left.\gamma((\Delta x- \Delta z)(-2\gamma \Delta tv\sqrt{2}) +(\Delta x+\Delta z)^2\right]\\
		-\frac{\gamma^2}{2}\left[\frac{v^2}{c^2}(\Delta z-\Delta x)^2+2v(\Delta z-\Delta x)\sqrt{2}\Delta t+2c^2(\Delta t)^2\right]\\
		=(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}
...
\begin{equation*}
	\begin{split}
		\frac{1}{2}\left[(\Delta x- \Delta z)^2 +2\gamma^2(\Delta t)^2v^2+(\Delta x+\Delta z)^2\right.\\
		\left.-2c^2\gamma^2(\Delta t)^2\right] =(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}

\begin{equation*}
	\begin{split}
		\frac{1}{2}\left[2(\Delta x)^2+2(\Delta z)^2 +2\gamma^2(\Delta t)^2v^2-2c^2\gamma^2(\Delta t)^2\right] =(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}

\begin{equation*}
	\begin{split}
		(\Delta x)^2+(\Delta z)^2 -c^2\gamma^2(\Delta t)^2(1-\frac{v^2}{c^2}) =(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}

\begin{equation*}
	\begin{split}
		(\Delta x)^2+(\Delta z)^2 -c^2(\Delta t)^2 =(\Delta x)^2+(\Delta z)^2-c^2(\Delta t)^2
	\end{split}
\end{equation*}
